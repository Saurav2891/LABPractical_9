package com.saurav_ranjan.labexp_9.data;
...
public class TaskProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        // Expected "query all" Uri: content://com.google.developer.taskmaker/tasks
        // Expected "query one" Uri: content://com.google.developer.taskmaker/tasks/{id}
...
//        return null;
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        // Implement existing task update
        // Expected Uri: content://com.google.developer.taskmaker/tasks/{id}
        final SQLiteDatabase db = mDbHelper.getWritableDatabase();
